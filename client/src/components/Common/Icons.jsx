...
const Icons = ({width, height})=> {
  return(
    <div className="icons">
      <span className="share-link" role="link">
      <a href="https://www.instagram.com" target="_blank" aria-label="post product on instagram">
...
<stop offset="1" stopColor="#6A45BE" stopOpacity="0"/>
    ...
    <span className="share-link" role="link" >
    <a href="https://www.facebook.com/" target="_blank" aria-label="post product on facebook">
    ...
    <span className="share-link" role="link" >
    <a href="https://twitter.com/" target="_blank" aria-label="post product on twitter">
